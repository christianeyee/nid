...
public class Mapper {
	...
	public static void map(Data data) {
		...
		//land.add(data.land);
		//wrong_fragment.add(data.wrong_fragment);
		//urgent.add(data.urgent);
		//hot.add(data.hot);
		//num_failed_logins.add(data.num_failed_logins);
		//logged_in.add(data.logged_in);
		//num_compromised.add(data.num_compromised);
		//root_shell.add(data.root_shell);
		//su_attempted.add(data.su_attempted);
		//num_root.add(data.num_root);
		//num_file_creations.add(data.num_file_creations);
		//num_shells.add(data.num_shells);
		//num_access_files.add(data.num_access_files);
		//num_outbound_cmds.add(data.num_outbound_cmds);
		//is_host_login.add(data.is_host_login);
		//is_guest_login.add(data.is_guest_login);
